...
var reservation = /** @class */ (function () {
    ...
    reservation.create = function (restaurant_id, name, connection, time) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        db = _a.sent();
                        id = uuid_1.v4();
                        collection = db.db("CS554-G2-Final").collection("reservation");
                        return [4 /*yield*/, collection.insert({ id: id, restaurant_id: restaurant_id, name: name, connection: connection, time: time })];
                    case 2:
                        _a.sent();
                        db.close();
    ...
    reservation.find = function (name) {
        return __awaiter(this, void 0, void 0, function () {
